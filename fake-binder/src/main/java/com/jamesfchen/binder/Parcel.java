 ...
 * {@link Parcelable} interface), and references to live {@link android.os.IBinder}
 ...
 */
public final class Parcel extends HybridClassBase {
    ...
    public final static Parcelable.Creator<String> STRING_CREATOR = new Parcelable.Creator<String>() {
        public String createFromParcel(android.os.Parcel source) {
...
//        init(nativePtr);
    ...
    private static native boolean nativeReplaceCallingWorkSourceUid(long nativePtr, int workSourceUid);
...
//                    VMRuntime.getRuntime().registerNativeFree(-delta);
     ...
     * @see Parcelable
     */
    public <T extends Parcelable> void writeTypedArrayMap(@Nullable ArrayMap<String, T> val, int parcelableFlags) {
        if (val == null) {
            writeInt(-1);
            return;
        }
...
//        val.writeToParcel(this, 0);
    ...
    public final void writeBinderArray(@Nullable android.os.IBinder[] val) {
        if (val != null) {
            int N = val.length;
            writeInt(N);
            for (int i = 0; i < N; i++) {
    ...
    public final void readBinderArray(@NonNull android.os.IBinder[] val) {
        int N = readInt();
        if (N == val.length) {
            for (int i = 0; i < N; i++) {
                val[i] = readStrongBinder();
     ...
     * @see Parcelable
     */
    public final <T extends Parcelable> void writeTypedSparseArray(@Nullable SparseArray<T> val, int parcelableFlags) {
        if (val == null) {
            writeInt(-1);
            return;
        }
     ...
     * @see #readBinderList
     */
    public final void writeBinderList(@Nullable List<android.os.IBinder> val) {
        if (val == null) {
            writeInt(-1);
            return;
        }
     ...
     */
    public final <T extends Parcelable> void writeTypedArray(@Nullable T[] val, int parcelableFlags) {
        if (val != null) {
            int N = val.length;
            writeInt(N);
            for (int i = 0; i < N; i++) {
     ...
     * @see #readTypedObject
     */
    public final <T extends Parcelable> void writeTypedObject(@Nullable T val, int parcelableFlags) {
        if (val != null) {
            writeInt(1);
//            val.writeToParcel(this, parcelableFlags);
    ...
    public final void writeValue(@Nullable Object v) {
        ...
        } else if (v instanceof android.os.IBinder) {
...
//        return bundle;
     ...
     */
    public final @Nullable
    <T extends Parcelable> SparseArray<T> createTypedSparseArray(@NonNull Parcelable.Creator<T> creator) {
     ...
     */
    public final @Nullable
    <T extends Parcelable> ArrayMap<String, T> createTypedArrayMap(@NonNull Parcelable.Creator<T> creator) {
        final int count = readInt();
        if (count < 0) {
            return null;
        }
...
//            map.append(key, value);
     ...
     */
    @Nullable
    public final ArrayList<android.os.IBinder> createBinderArrayList() {
        int N = readInt();
        if (N < 0) {
            return null;
        }
        ArrayList<android.os.IBinder> l = new ArrayList<android.os.IBinder>(N);
        while (N > 0) {
     ...
     */
    @NonNull
    public final <T extends Parcelable> List<T> readParcelableList(@NonNull List<T> list, @Nullable ClassLoader cl) {
        final int N = readInt();
        if (N == -1) {
            list.clear();
            return list;
...
//            return c.createFromParcel(this);
     ...
     * @see #writeTypedArray
     */
    public final <T extends Parcelable> void writeParcelableArray(@Nullable T[] value, int parcelableFlags) {
        if (value != null) {
            int N = value.length;
            writeInt(N);
            for (int i = 0; i < N; i++) {
...
//        return (T) creator.createFromParcel(this);
    ...
    @SuppressWarnings("unchecked")
    @Nullable
    public final <T extends Parcelable> T readCreator(@NonNull Parcelable.Creator<?> creator, @Nullable ClassLoader loader) {
        if (creator instanceof Parcelable.ClassLoaderCreator<?>) {
            Parcelable.ClassLoaderCreator<?> classLoaderCreator = (Parcelable.ClassLoaderCreator<?>) creator;
//            return (T) classLoaderCreator.createFromParcel(this, loader);
        }
//        return (T) creator.createFromParcel(this);
     ...
     */
    @Nullable
    public final <T extends Parcelable> T[] readParcelableArray(@Nullable ClassLoader loader, @NonNull Class<T> clazz) {
        int N = readInt();
        if (N < 0) {
            return null;
        }
    ...
    /* package */ void readMapInternal(@NonNull Map outVal, int N, @Nullable ClassLoader loader) {
        while (N > 0) {
    ...
    /* package */ void readArrayMapInternal(@NonNull ArrayMap outVal, int N, @Nullable ClassLoader loader) {
        if (DEBUG_ARRAY_MAP) {
            RuntimeException here = new RuntimeException("here");
            here.fillInStackTrace();
...
//        outVal.validate();
    ...
    /* package */ void readArrayMapSafelyInternal(@NonNull ArrayMap outVal, int N, @Nullable ClassLoader loader) {
        if (DEBUG_ARRAY_MAP) {
            RuntimeException here = new RuntimeException("here");
            here.fillInStackTrace();
    ...
    public @Nullable
    ArraySet<? extends Object> readArraySet(@Nullable ClassLoader loader) {
...
//            result.append(value);
    ...
    private void readArrayInternal(@NonNull Object[] outVal, int N, @Nullable ClassLoader loader) {
        for (int i = 0; i < N; i++) {
            Object value = readValue(loader);
            //Log.d(TAG, "Unmarshalling value=" + value);
            outVal[i] = value;
    ...
    private void readSparseArrayInternal(@NonNull SparseArray outVal, int N, @Nullable ClassLoader loader) {
        while (N > 0) {
            int key = readInt();
            Object value = readValue(loader);
